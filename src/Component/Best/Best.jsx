          ...
          >
            ...
            <p className="relative px-6 py-1 text-lg italic text-center text-gray-100 dark:text-gray-800">
              <svg
                ...
                viewBox="0 0 512 512"
                fill="currentColor"
                className="w-5 lg:w-8 h-5 lg:h-8 text-violet-400 dark:text-violet-600"
              >
              ...
              <svg
                ...
                viewBox="0 0 512 512"
                fill="currentColor"
                className="absolute right-0 w-5 lg:w-8 h-5 lg:h-8 text-violet-400 dark:text-violet-600"
              >
